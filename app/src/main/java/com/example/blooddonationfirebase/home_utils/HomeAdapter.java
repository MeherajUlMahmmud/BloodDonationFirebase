package com.example.blooddonationfirebase.home_utils;
...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.RequestCardViewHolder> {

    private Context context;
    private List<Request> requestList;

    public HomeAdapter(Context context, List<Request> requestList) {
